...
<%@ taglib uri="http://java.sun.com/jsp/jstl/fmt" prefix="fmt" %>
        ...
        <head>
            ...
            <link href="/pipoca_spring_aula02/css/bootstrap.min.css" rel="stylesheet">
            <link href="/pipoca_spring_aula02/css/style.css" rel="stylesheet">
        </head>
	...
	<div id="main" class="container">
		...
		<div id="actions" class="row">
			<div class="col-md-12">
				<a href="/pipoca_spring_aula02/alterar_filme/${filme.id}" class="btn btn-primary">Editar</a> 
				<a href="#" class="btn btn-danger" data-toggle="modal" data-target="#delete-modal">Excluir</a> 
				<a href="../../pipoca_spring_aula02/listar_filmes" class="btn btn-default">Voltar</a>
			</div>
		</div>
	</div>
	<script src="/pipoca_spring_aula02/js/jquery.min.js"></script>
    <script src="/pipoca_spring_aula02/js/bootstrap.min.js"></script>
  </body>
</html>