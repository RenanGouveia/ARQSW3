...
<head>
    ...
    <link href="/pipoca_spring_aula05/css/bootstrap.min.css" rel="stylesheet">
    <link href="/pipoca_spring_aula05/css/style.css" rel="stylesheet">
</head>
<body>
                        ...
                        <div class="carousel fdi-Carousel slide" id="eventCarousel" data-interval="0">
                            ...
                            <c:forEach var="filme" items="${filmes5}" varStatus="loop">        	
								...
								<c:otherwise>
                                    ...
                                    <div class="col-md-4">
                                        <a href="visualizar/${filme.id}"><img src="${filme.posterPath}" class="size-img img-responsive center-block"></a>
                                        <br/>
...
<script src="/pipoca_spring_aula05/js/jquery.min.js"></script>
<script src="/pipoca_spring_aula05/js/bootstrap.min.js"></script>
<script src="/pipoca_spring_aula05/js/custom.js"></script> 
</body>
</html>